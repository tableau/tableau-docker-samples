...
Please start a discuss on the [Home repo issue tracker](./issues).

## Bugs and feature requests
Please log a new issue in the [Home repo issue tracker](./issues).
...
The Tableau Software is the legal owner of the project and the project has adopted the Code of Conduct.
